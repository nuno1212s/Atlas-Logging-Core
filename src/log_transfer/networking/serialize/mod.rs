...
impl<RQ, P> LogTransferMessage<RQ, P> for NoProtocol {
    ...
    #[cfg(feature = "serialize_capnp")]
    fn serialize_capnp(_: febft_capnp::cst_messages_capnp::cst_message::Builder, msg: &Self::LogTransferMessage) -> std::result::Result<()> {
        unimplemented!()
    }

    #[cfg(feature = "serialize_capnp")]
    fn deserialize_capnp(_: febft_capnp::cst_messages_capnp::cst_message::Reader) -> std::result::Result<Self::LogTransferMessage> {
        unimplemented!()
    }
}